...
## Get a list of rejected jobs

> To obtain a list of rejected jobs, use the following code:

```shell
curl -X "GET" "https://www.autobutler.dk/api/v2/mechanics/archive/jobs/rejected" \
     -H "Authorization: token"
```

```javascript
jQuery.ajax({
  url: "https://www.autobutler.dk/api/v2/mechanics/archive/jobs/rejected",
  type: "GET",
  headers: {
    "Authorization": "token",
  },
...
This endpoint returns a list of mechanicbooking jobs rejected by the workshop.

### HTTP Request

`GET https://www.autobutler.dk/api/v2/mechanics/archive/jobs/rejected`
